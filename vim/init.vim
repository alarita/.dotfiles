...
let g:mocha_ts_command = ":vsplit term://node bundle-tests.js --entrypath={entry} && yarn mocha --timeout 5000 --enable-source-maps --require=src/test/setup.js test-bundles/{spec}"
